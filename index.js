...
*/
function processLength(listLength, callback) 
{
  return callback(listLength.length);
}
...
{
  const upperCase = runners.map(function(name)
  {
...
{
  const filterResult = runners.filter(function(size)
  {
